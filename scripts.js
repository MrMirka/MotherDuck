...
function checkTurn(){
	if(positions.length > 4){
		...
		let moveY = ( panYTouch[panYTouch.length-1] - panYTouch[panYTouch.length-4] ) / 2 ;
		let moveX = positions[positions.length-1] - positions[positions.length-4];
